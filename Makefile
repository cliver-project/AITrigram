...
# ghcr.io/cliver-project/aitrigram-olm-bundle:$VERSION and ghcr.io/cliver-project/aitrigram-olm-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/cliver-project/aitrigram-olm
...
IMG ?= ghcr.io/cliver-project/aitrigram-controller:latest
...
.PHONY: all
all: generate manifests bundle build test  ## 'make all' do generate, manifests, bundle, build and test for unit test
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name aitrigram-olm-builder
	$(CONTAINER_TOOL) buildx use aitrigram-olm-builder
...
deploy: manifests kustomize ## Deploy controller to the K8s cluster specified in ~/.kube/config.
	...
	cd config/manager && $(KUSTOMIZE) edit set image controller=ghcr.io/cliver-project/aitrigram-controller:latest
